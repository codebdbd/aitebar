...
| `Context1Hotkey`-`Context4Hotkey` | не назначено | Зарезервированные поля модели, не представлены в текущем UI |
...
Hotkey-кнопки могут отправлять сочетания клавиш в активное окно через системный ввод.
