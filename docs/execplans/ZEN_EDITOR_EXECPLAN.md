...
- [x] (2026-08-21) Completed the post-audit hardening: TXT export preserves all user text, recovery retains corrupt source files, backup retention is best-effort, protective snapshots are serialized, and undo history has an 8 MiB payload budget. Focused Zen tests pass 74/74 and the complete Release suite passes 1,337/1,337.
